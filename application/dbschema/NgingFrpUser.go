...
type Slice_NgingFrpUser = factory.Slicex[*NgingFrpUser]
...
func (a *NgingFrpUser) CtxFrom(source factory.Model) factory.Model {
...
func (a *NgingFrpUser) List(recv interface{}, mw func(db.Result) db.Result, page, size int, args ...interface{}) (func() int64, error) {
	...
	if err == nil {
		switch v := recv.(type) {
		case *[]*NgingFrpUser:
			err = a.base.FireReaded(a, queryParam, Slice_NgingFrpUser(*v))
		case []*NgingFrpUser:
			err = a.base.FireReaded(a, queryParam, Slice_NgingFrpUser(v))
		case factory.Ranger:
...
func (a *NgingFrpUser) Clone() *NgingFrpUser {
	cloned := NgingFrpUser{Id: a.Id, ServerId: a.ServerId, CustomerId: a.CustomerId, Uid: a.Uid, Username: a.Username, Password: a.Password, Banned: a.Banned, Bandwidth: a.Bandwidth, TrafficUsed: a.TrafficUsed, TrafficTotal: a.TrafficTotal, IpWhitelist: a.IpWhitelist, IpBlacklist: a.IpBlacklist, Start: a.Start, End: a.End, Created: a.Created, Updated: a.Updated}
	cloned.CtxFrom(a)
	return &cloned
}
...
func (a *NgingFrpUser) Validate(column string, value interface{}) error {
	return a.base.Validate(a, column, value)
}

func (a *NgingFrpUser) TrimOverflowText(column string, value string) string {
